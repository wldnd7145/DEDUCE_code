# Exp: Fisher Multi-task (strong selectivity, c=0.1)
# Same as exp_fisher_multitask but FISHER_C=0.1 (10x stronger selectivity)
...
def get_parser() -> ArgumentParser:
    parser = ArgumentParser(description='Exp: Fisher Multi-task (strong)')
...
class ExpFisherMultitaskStrong(ContinualModel):
    NAME = 'exp_fisher_multitask_strong'
    COMPATIBILITY = ['class-il', 'domain-il', 'task-il', 'general-continual']

    FISHER_C = 0.1  # strong selectivity (10x)

    def __init__(self, backbone, loss, args, transform):
        super(ExpFisherMultitaskStrong, self).__init__(backbone, loss, args, transform)
